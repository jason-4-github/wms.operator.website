          ...
          <Content id="content">
            ...
            <Col span={24}>
              <Card bodyStyle={{ padding: '10px' }}>
                <Row>
                  <Col>
                    { ReturnContainer.showTable('Data of This Part NO.', 140, 'returnDataOfPartNO', 'returnDataOfPartNO') }
                  </Col>
                </Row>
                <Row id="hrRow"><hr /></Row>
                <Row>
                  <Col span={6}>
                    <Card title="Task Status" bodyStyle={{ padding: '10px', textAlign: 'center' }}>
                      ...
                      <div id="faceRadio">
                        { ReturnContainer.showRadioGroup(['Face1', 'Face2', 'Face3', 'Face4']) }
                      </div>
                      <div id="startButton">
                  ...
                  <Col span={10} id="bottomMidTable">
                    { ReturnContainer.showTable('Receive Detail', 140, 'returnDataOfRack', 'returnDataOfRack') }
                  </Col>
                  <Col span={8}>
                    <Card title="Scan" bodyStyle={{ padding: '10px' }}>
                      <Col span={6} className="scanRadio">Date Code: </Col>
                      <Col span={18} className="scanRadio">
                        { ReturnContainer.showRadioGroup(['3 digit', '4 digit', '8 digit']) }
                      </Col>
                      <Col span={6} className="scanRadio">QTY: </Col>
                      <Col span={18} className="scanRadio">
                        { ReturnContainer.showRadioGroup(['5 digit', '6 digit']) }
                      </Col>
